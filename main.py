...
# Inicia Pipeline
pipelineBuffer = CSVBuffer("resultado/pipeline.csv", ["IF", "ID", "EX", "MEM", "WB"], "NOP" )
...
registradoresBuffer = CSVBuffer("resultado/registradores.csv", registradores, 0)
bancoDeRegistradores = Registradores(registradoresBuffer)

#Inicia MP
memoriaBuffer = CSVBuffer("resultado/memoria.csv", list(range(1000)), hex(0))
mp = MP(memoriaBuffer)
